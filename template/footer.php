          ...
          <li class="special-dropdown">
            <div class="row">
              ...
              <div class="column-10">
                ...
                <button type="button" id="sidebuy" class="btnnavbar" style="text-align: left;margin-top: -7px;height: 31px;">
            ...
            <div id="buymenu" style="display: none;">
              <div class="column-12"  style="padding: 0px;margin: 5px 0px 5px 0px;">
                ...
                <a href="member/transactions.php?list=buy" style="width: 100%;padding-left: 27px;">
              ...
              <div class="column-12"  style="padding: 0px;margin: 5px 0px 5px 0px;">
                ...
                <a href="member/transactions.php?list=cancel" style="width: 100%;padding-left: 27px;">
          ...
          <li class="special-dropdown">
            ...
            <div id="settingmenu" style="display: none;">
              <div class="column-12"  style="padding: 0px;margin: 5px 0px 5px 0px;">
                ...
                <a href="member/edit_akun.php" style="width: 100%;padding-left: 27px;">
              ...
              <div class="column-12"  style="padding: 0px;margin: 5px 0px 5px 0px;">
                ...
                <a href="member/edit_pass.php" style="width: 100%;padding-left: 27px;">
              ...
              if(!$lapak){
                ...
                <div class="column-12"  style="padding: 0px;margin: 5px 0px 5px 0px;">
                  ...
                  <a href="member/edit_toko.php" style="width: 100%;padding-left: 27px;">
