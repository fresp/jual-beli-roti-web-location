...
<head>
	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			var dataTable = $('#listmember-grid').DataTable( {
				"processing": true,
				"serverSide": true,
				"ajax":{
						url :"../data/listmember.php", // json datasource
						type: "post",  // method  , by default get
						error: function(){  // error handling
							$(".listmember-grid-error").html("");
							$("#listmember-grid").append('<tbody class="listmember-grid-error"><tr><th colspan="5">Data Tidak Ditemukan</th></tr></tbody>');

							$("#listmember-grid_processing").css("display","none");
...
<body style="background-color: #ECF0F5;">
	...
	elseif($_SESSION['alert']=='passwordsukses'){
		?>
		<script type='text/javascript'>
			$(document).ready( function () {
				cheers.success({
					title: 'berhasil update',
					message: 'Berhasil Update Password member',
					alert: $('select[name="alert"]').val(),
				});
			}); 
		</script>
				...
				<div class="panel-body">
					<div class="row">	
						<div class="col-md-12 table-fixed" style="border: 0px">
							<table id="listmember-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
								<thead>
									<tr>
										<th>Nama</th>
										<th>Email</th>
