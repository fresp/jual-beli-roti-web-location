...
<head>
	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			var dataTable = $('#listlapak-grid').DataTable( {
				"processing": true,
				"serverSide": true,
				"ajax":{
						url :"../data/listlapak.php", // json datasource
						type: "post",  // method  , by default get
						error: function(){  // error handling
							$(".listlapak-grid-error").html("");
							$("#listlapak-grid").append('<tbody class="listlapak-grid-error"><tr><th colspan="5">Data Tidak Ditemukan</th></tr></tbody>');

							$("#listlapak-grid_processing").css("display","none");
...
<body style="background-color: #ECF0F5;">
	...
	<div id="panel-header">
		...
		<div class="panel-title">List Penjual</div>
				...
				<div class="panel-body">
					<div class="row">	
						<div class="col-md-12 table-fixed" style="border: 0px">
							<table id="listlapak-grid"  cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
								<thead>
									<tr>
										<th>username toko</th>
										<th>nama toko</th>
